    ...
    <section className='container my-0 mx-auto'>
      ...
      <input 
       ...
       <textarea 
        ...
        ></textarea>
       <button className='w-40 inline-flex justify-center rounded-md border border-transparent bg-[#55A747] px-8 py-2 text-white hover:bg-[#1d4fd846] hover:text-[#1d4fd8] focus:outline-none focus:ring-offset-2 focus:ring-2 focus:ring-black'>Submit</button>
       </section>
    </section>
  )
}
