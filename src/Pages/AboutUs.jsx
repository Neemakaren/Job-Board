  ...
  return (
    ...
    <section className='w-full h-60 bg-cover bg-center flex  mt-8 shadow-lg bg-black-800 bg-opacity-100 mt-20 here'>
      <div className="py-6 px-4 font-bold w-100 text-white backdrop-blur-md bg-black/80 w-full h-full">
        <div className='flex flex-col justify-center items-center mt-8 py-6 w-[1280px] my-0 mx-auto'>
    ...
    <section>
      ...
      <div className='w-[1280px] my-0 mx-auto w-full grid grid-cols-1 gap-8  sm:grid-cols-2 lg:grid-cols-3 mt-8 p-8'>
        <div>
    ...
    <section className=' grid-cols-1 md:grid md:grid-cols-2 w-[1280px] my-0 mx-auto my-8 p-4'>
